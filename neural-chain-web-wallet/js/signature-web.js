// простой файл для подписания пакета
var signature, generateKeys, acc_num, hash;
(function(){
	hesh = function(str, len) {
		len = len || 16;
		str = str || "";
	...
	signature = function(objMessage, privateKey, pass, bolBackWithObject) {
		var protecttor;
	...
	generateKeys = function(password, $Length) {
		$Length = $Length || 128;
		var g = grb($Length / 2),
	...
	acc_num = function(privateKey){
		return privateKey.hash(2048*5).match(/[0-9A-F]{4}/g).map(function(a) { 
